...
void video_putch(uint8_t);
void video_newline(void);

// Terminal control
#define c_putch(c) video_putch(c)
#define c_getch( ) kbd_read()
#define c_kbhit( ) kbd_available()
...
// SAVE&LOAD BASIC program to tail of FLASH
void isave() {
